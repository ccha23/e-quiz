...
wget https://github.com/trampgeek/moodle-qtype_coderunner/archive/refs/tags/v5.3.0.tar.gz \
...
wget https://github.com/trampgeek/moodle-qbehaviour_adaptive_adapted_for_coderunner/archive/refs/tags/v1.4.3.tar.gz \
