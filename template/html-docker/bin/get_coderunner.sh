...
wget https://github.com/trampgeek/moodle-qtype_coderunner/archive/refs/tags/v5.8.0.tar.gz \
...
wget https://github.com/trampgeek/moodle-qbehaviour_adaptive_adapted_for_coderunner/archive/refs/tags/v1.4.4.tar.gz \
